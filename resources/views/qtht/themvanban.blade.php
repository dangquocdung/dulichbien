            ...
            {!! Form::open(['method'=>'POST','url'=>'qtht/van-ban/them-van-ban','enctype'=>'multipart/form-data']) !!}
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="trichyeuvb" value="{{ old('trichyeuvb')}}" placeholder="Trích yêu văn bản" required=""/>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" name="ngaybanhanhvb" value="{{ old('ghichu')}}" required=""/>
                </div>
