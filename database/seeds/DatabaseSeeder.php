...
class UsersTableSeeder extends Seeder
{
    public function run()
    {
      ...
      DB::table('users')->insert([
        ['name' => 'Quản trị viên', 'email' => 'quantrivien@gmail.com', 'password'=>bcrypt('123456@'), 'level'=>'15'],
        ['name' => 'Tổng biên tập', 'email' => 'tongbientap@gmail.com', 'password'=>bcrypt('123456@'), 'level'=>'3'],
        ['name' => 'Biên tập viên', 'email' => 'bientapvien@gmail.com', 'password'=>bcrypt('123456@'), 'level'=>'2']
...
class MenuTopTableSeeder extends Seeder
{
    public function run()
    {
      ...
      DB::table('menutop')->insert([
          ...
          ['ten' => 'Thông tin chỉ đạo, điều hành', 'slug' => str_slug('Thông tin chỉ đạo, điều hành'),'thutu' => '4']
      ]);
    }
}
...
class LoaiTinTableSeeder extends Seeder
{
    public function run()
    {
      ...
      DB::table('loaitin')->insert([
          ...
          ['ten' => 'Văn bản quy phạm pháp luật','slug' => str_slug('Văn bản quy phạm pháp luật'),'menutop_id' => '4'],
          ['ten' => 'Văn bản chỉ đạo, điều hành','slug' => str_slug('Văn bản chỉ đạo, điều hành'),'menutop_id' => '4'],
          ['ten' => 'Văn bản xử lý kiến nghị, yêu cầu','slug' => str_slug('Văn bản xử lý kiến nghị, yêu cầu'),'menutop_id' => '4'],
          ['ten' => 'Văn bản xử lý khiếu nại, tố cáo','slug' => str_slug('Văn bản xử lý khiếu nại, tố cáo'),'menutop_id' => '4'],
          ['ten' => 'QĐ Khen thưởng, kỉ luật','slug' => str_slug('QĐ Khen thưởng, kỉ luật'),'menutop_id' => '4']
      ]);
    }
}
